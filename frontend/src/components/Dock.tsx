...
const Dock = () => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[9999]">
      <div className="glass-card gold-border flex items-center gap-1 px-3 py-2 rounded-2xl shadow-lg" style={{ boxShadow: "0 8px 32px rgba(74,64,57,0.2), 0 0 0 1px rgba(214,186,158,0.1)" }}>
        {dockItems.map((item) => {
